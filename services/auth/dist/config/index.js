...
class Base {
  static get schema() {
    return {
      ...
      JWT_SECRET: import_celebrate.Joi.string().required(),
      ACCESS_TOKEN_EXPIRY: import_celebrate.Joi.string().optional(),
      REFRESH_TOKEN_EXPIRY: import_celebrate.Joi.string().optional(),
      USER_SERVICE_BASE_URL: import_celebrate.Joi.string().required(),
      EMAIL_SERVICE_BASE_URL: import_celebrate.Joi.string().required(),
      FRONTEND_BASE_URL: import_celebrate.Joi.string().required()
    };
  }
  static get values() {
    return {
